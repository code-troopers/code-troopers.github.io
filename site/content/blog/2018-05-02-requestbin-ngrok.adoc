...
Nous allons pouvoir nous abstraire de tout cela grâce à *https://ngrok.com/[ngrok]*. Il s'agit d'un petit outil qui permet d'exposer des services locaux sur des urls publiques (en HTTP ou HTTPS), sans avoir à faire de quelconque configuration de notre équipement réseau.
