...
* L'achat de locaux plus grands ou plus confortables permettant d’accueillir de nouveaux collaborateurs plus sereinement. (on vient d’emménager dans nos nouveaux locaux à MAME, à Tours, entre le M & le A, vous êtes les bienvenus pour nous exposer vos projets, si vous voulez en savoir plus sur nos nouveaux locaux je vous invite à vous rendre sur *http://code-troopers.com/2018/06/11/mame/[cette page, window="_blank"]*.
